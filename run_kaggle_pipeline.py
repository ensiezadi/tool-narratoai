...
环境变量：
    ...
    KAGGLE_API_TOKEN      Kaggle API Token（替代 --kaggle-token）
...
""",
    ...
    os.environ.setdefault("KAGGLE_USERNAME", args.kaggle_username or os.getenv("KAGGLE_USERNAME") or "")
    os.environ.setdefault("KAGGLE_API_TOKEN", args.kaggle_token or os.getenv("KAGGLE_API_TOKEN") or "")
